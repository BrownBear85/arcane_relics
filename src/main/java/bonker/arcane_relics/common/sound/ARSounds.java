...
public class ARSounds {
    ...
    public static final RegistryObject<SoundEvent> EVIL_LOOP = registerSoundEvent("evil_loop");
    public static final RegistryObject<SoundEvent> EVIL_CAST = registerSoundEvent("evil_cast");
